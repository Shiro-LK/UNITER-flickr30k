...
if __name__ == '__main__':
    # Extract features in npz format
    args = parse_args()
    ...
    image_id = [(args.filename, os.path.splitext(os.path.split(args.filename)[-1])[0])]
    ...
    procs = []
    save_to_folder = args.outfile
    prefix = args.prefix + "_"
    
    
    generate_tsv(gpus[0], prototxt=args.prototxt, weights=args.caffemodel, image_ids=image_id, out_dir=save_to_folder, prefix=prefix)
